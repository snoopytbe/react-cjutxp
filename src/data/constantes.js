...
export const temples = ["Ramsay (RDC)", "Berteaux (ETG)", "Aucun temple"];

export const salleshumides = ["Salle humide Cuisine", "Salle humide Jardin", "Les 2 salles humides", "Aucune salle humide"];

const horaires = [];
for (let i = 9; i <= 23; i++) for (let j = 0; j < 2; j++) horaires.push(i + "h" + (j === 0 ? "00" : "30"));
